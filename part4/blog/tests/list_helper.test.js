...
describe('favoriteBlog', () => {
  ...
  test('finds the blog with most likes from a list', () => {
...
describe('mostBlogs', () => {
  test('finds author with most blogs in a list of blogs', () => {
...
describe('mostLikes', () => {
  test('finds author with most likes in a list of blogs', () => {
